...
function validateDOB(dob){
    ...
    let monthDiff = todays.getMonth() - birthdate.getMonth();
if ((todays.getDate() < birthdate.getDate())||monthDiff<0) 
{
age--;
}
if (age<18 || age>55) 
{
dob.setCustomValidity(" not between 18 and 55");
dob.reportValidity();
}
else
{
